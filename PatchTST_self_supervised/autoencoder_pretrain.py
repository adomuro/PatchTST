...
print('args:', args)
args.save_pretrained_model = 'patchtst_pretrained_cw'+str(args.context_points)+'_mask_scheme_'+args.mask_type+'_patch'+str(args.patch_len) + '_stride'+str(args.stride) + '_epochs-pretrain' + str(args.n_epochs_pretrain)  + '_model' + str(args.pretrained_model_id)
...
def find_lr():
    ...
    cbs += [PatchNoiseCB(patch_len=args.patch_len, stride=args.stride, indicator=args.indicator)]
